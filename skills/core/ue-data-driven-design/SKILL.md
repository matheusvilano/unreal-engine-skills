...
- `UPrimaryDataAsset` (`DataAsset.h`:47) — adds `GetPrimaryAssetId()` for `UAssetManager`
  ...
  have many instances (hundreds of items). See `ue-asset-management`.
...
Related skills: `ue-asset-management`, `ue-gameplay-tags`, `ue-project-structure`, `ue-cpp-fundamentals`.
