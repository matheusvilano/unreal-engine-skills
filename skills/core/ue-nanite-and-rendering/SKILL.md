...
`ue-lighting-and-lumen`), and **Virtual Shadow Maps** into a coherent high-fidelity pipeline.
...
2. **Overdraw** — translucency is rendered unconditionally and accumulates; limit layered
   particles and glass materials (`ue-materials-and-shaders`).
...
6. Profile with `profileGPU` or Unreal Insights GPU track (`ue-profiling-and-optimization`).
...
Related skills: `ue-lighting-and-lumen`, `ue-meshes-static-and-skeletal`, `ue-profiling-and-optimization`,
