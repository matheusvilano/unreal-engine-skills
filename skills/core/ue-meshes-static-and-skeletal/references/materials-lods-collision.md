...
See `ue-materials-and-shaders` for the full `UMaterialInterface` hierarchy, parameter
...
individually. See `ue-physics-and-chaos` for trace channels, `FHitResult`, and overlap
event setup.
